...
class EnergyProductionsController extends Controller
{
    ...
    public function Index(Request $request) 
    {
        ...
        })->select('materialcategory','materialcatname','origin','energysource','efficiency','method','panelangle','paneldirection','energycategory','inputamount','inputunit','heatingpowerkw','energyperunitkwh','electrpowerkw','heatingpowerkw','heatjanuary','heatfebruary','heatmarch','heatapril','heatmay','heatjune','heatjuly','heatjune','heataugust','heatseptember','heatoctober','heatnovember','heatdecember','electjanuary','electfebruary','electmarch','electapril','electmay','electjune','electjuly','electaugust','electseptember','electoctober','electnovember','electdecember')->orderBy('materialcategory','asc')->get();
